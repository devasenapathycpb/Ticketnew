...
public class Bhopal {
	...
	if(driver.findElement(By.id("tn_city_search")).isEnabled())
		  {
			  ...
			  driver.findElement(By.id("tn_city_search")).sendKeys("Bhopal");
			  Thread.sleep(5000);
			   driver.findElement(By.xpath("//strong[.='Bhopal']//parent::div")).click();
				Thread.sleep(5000);	
		  }
		 else
		 {
	...
	@Test(priority=41)
	public static void TC_2020() throws InterruptedException, Exception {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//p[.='PREMIER NORMAL']")).click();
		Thread.sleep(2000);
